...
# ── Файлы ────────────────────────────────────────────────────
SYSTEM_PROMPT_FILE = DIRS["data"] / "system_prompt.txt"
PHRASES_FILE       = DIRS["data"] / "phrases.txt"
QA_RESPONSES_FILE  = DIRS["data"] / "qa_responses.json"
DB_FILE            = BASE_DIR / "Jarvis.db"
...
USER_SESSION_STRING = os.getenv("USER_SESSION_STRING", "")          # StringSession (альтернатива файлу)
CHROMA_PERSIST_DIR = str(BASE_DIR / "chroma_db")  # не создаётся автоматически
