...
def _gdrive_make_jwt() -> str:
    """Создаёт JWT для Service Account без внешних библиотек."""
...
async def _gdrive_refresh_token() -> str:
    """Получает access_token через Service Account JWT. Кэширует на 55 минут."""
...
async def _gdrive_get_or_create_folder() -> str:
    """Возвращает ID папки Jarvis_Backup. Создаёт если нет."""
            ...
            try:
                ...
                if config.GOOGLE_SERVICE_ACCOUNT:
                    ...
                    if _ok_j and _ok_d:
                        ...
                        # Если Google Drive не работает — отправляем файлы напрямую
